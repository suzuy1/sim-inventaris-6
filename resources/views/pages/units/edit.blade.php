            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('unit.update', $unit->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" value="{{ old('name', $unit->name) }}">
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Kode Unit (Opsional)</label>
                        <input type="text" name="code" class="w-full border-gray-300 rounded-md shadow-sm" value="{{ old('code', $unit->code) }}">
                    </div>
